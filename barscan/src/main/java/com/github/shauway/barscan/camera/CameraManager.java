...
public final class CameraManager {
    ...
    private int framingRectCenterTopOffset;
    ...
    public CameraManager(Context context, SurfaceHolder holder, int framingRectCenterTopOffset) {
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int surfaceFrameWidth = holder.getSurfaceFrame().width();
            int surfaceFrameHeight = holder.getSurfaceFrame().height();

            int width = findDesiredDimensionInRange(surfaceFrameWidth, MIN_FRAME_WIDTH, MAX_FRAME_WIDTH);
            int height = findDesiredDimensionInRange(surfaceFrameHeight, MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
            ...
            int leftOffset = (surfaceFrameWidth - width) / 2;
            int topOffset = (surfaceFrameHeight - height) / 2 - this.framingRectCenterTopOffset;
